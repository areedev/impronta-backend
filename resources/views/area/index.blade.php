...
@section('descripcion', 'Mantenedor de areas')
@section('contenido')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Areas</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                    <button data-bs-toggle="modal" data-bs-target="#addContactModal"
                        ...
                        <i class="ti ti-plus text-white me-1 fs-5"></i> Nueva Area
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-primary d-flex align-items-center rounded-top">
                        <h5 class="modal-title  text-white ">Nueva Area</h5>
                        <button type="button" class="btn-close  text-white " data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>

                    {!! Form::open(['route' => 'areas.store', 'method' => 'Post', 'enctype' => 'multipart/form-data']) !!}
...
@section('customjs')
    <script>
        $('body').on('click', '.editar-area', function(e) {
            e.preventDefault();
        ...
        $('#buscador').on('keyup', function() {
            ...
            $('#area-table').DataTable().search(valorBusqueda).draw();
        });
    </script>
@endsection
@push('script')
    {{ $dataTable->scripts() }}
    <script>
        $('#faena-table').on('draw.dt', function() {
