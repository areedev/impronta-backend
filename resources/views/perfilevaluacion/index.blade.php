    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Perfiles de Evaluaciones</h4>
        ...
        <div class="card card-body">
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                    <a href="{{route('perfilevaluaciones.create')}}"
                        class="btn btn-info d-flex align-items-center">
                        <i class="ti ti-plus text-white me-1 fs-5"></i> Nuevo Perfil
                    </a>
                </div>
            </div>
        </div>
...
@section('customjs')
    <script>
        ...
        $('#buscador').on('keyup', function() {
            ...
            $('#perfilevaluacion-table').DataTable().search(valorBusqueda).draw();
        });
    </script>
@endsection
@push('script')
    {{ $dataTable->scripts() }}
    <script>
        $('#perfilevaluacion-table').on('draw.dt', function() {
